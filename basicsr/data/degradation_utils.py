...
from basicsr.utils.image_utils import crop_img
...
class Degradation(object):
    ...
    def _degrade_by_type(self, clean_patch, degrade_type):
        if degrade_type == 0:
            ...
            # deblurgauss_5 radius = 5
            degraded_patch, clean_patch = self._add_gaussian_blur(clean_patch, radius=5)
        elif degrade_type == 7:
            # deblurgauss_5 radius = 5
            degraded_patch, clean_patch = self._add_gaussian_blur(clean_patch, radius=10)
        else:
