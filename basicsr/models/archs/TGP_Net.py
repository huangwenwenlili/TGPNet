...
class TGPNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.prompt_scaleout = nn.Linear(prompt_nf, out_channels, bias=True)
        ...
        self.prompt_shiftout = nn.Linear(prompt_nf, out_channels, bias=True)
    ...
    def forward(self, inp_img):
        ...
        ###########################
            ...
            if self.global_residual:
                out_dec_level1 = self.output(out_dec_level1)
                out_dec_level1 = out_dec_level1 * scaleout.view(-1, self.out_channels, 1, 1) + shiftout.view(-1, self.out_channels, 1, 1) + out_dec_level1
