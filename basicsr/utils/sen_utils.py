...
def GetQuadrupletsImg(img_cld,img_fake,img_truth,img_size=256,scale=2000):
    ...
    img_cld_nobright_RGB = getRGBImg(img_cld_nobright[:, :, 5], img_cld_nobright[:, :, 4], img_cld_nobright[:, :, 3], img_size) #add sar channel
    img_cld_RGB=getRGBImg(img_cld[:,:,5], img_cld[:,:,4], img_cld[:,:,3], img_size) # add sar channel
    # img_cld_nobright_RGB = getRGBImg(img_cld_nobright[:, :, 3], img_cld_nobright[:, :, 2], img_cld_nobright[:, :, 1], img_size)
    ...
    output_img[:, 3 * img_size:4 * img_size, :] = img_sar_RGB
    return output_img,img_cld_RGB,img_fake_RGB,img_truth_RGB,img_sar_RGB,img_cld_nobright_RGB